...
public class IntegrationService {
     ...
     * @throws IOException
     */
    public void writeUploadFile(String fileName, byte[] data) throws IOException {
     ...
     * @throws Exception
     */
    public Integer importXml(Campus campus, String xmlFileName) throws Exception {
	// Remove todas as importações anteriores
	deleteAllPreviousTimetables(campus);
	...
	relacionaProfessorPessoa(campus);
    ...
    /**
     * Importa os dados gravados do último XML e atualiza o cadastro de Professores,
     * Disciplinas, Cursos, Classes, Aulas, Periodo Letivo e Calendário de Aula.
     * 
     * @param idTimeTable     Código do timetable referente à importação do XML.
     * @param idPeriodoLetivo Código do Periodo letivo selecionado na importação do
     *                        XML
     * @throws Exception
     */
	...
	try {
		 ...
		 * "ak_item_reserva_nome" DO BANCO DE DADOS. DESTA FORMA NÃO SE ALTERA A
		 * CATEGORIA DA SALA DE AULA (OU LABORATÓRIOS) SE ELES JÁ EXISTIREM.
		 */
		// ItemReserva sala =
...
//		bean.setProgress(progress);
	...
	try {
		...
		/**
		 * Encontra a similaridade entre os nomes e ordena pela mais provável. Ignora
		 * taxas menores que 80%, pois só deve considerar pequenos erros de grafia de
		 * acentuação ou falta de preposições.
		 */
    ...
    /**
     * Lê toda a estrutura de cadastros do servidor LDAP e cadastra todas as pessoas
     * na base de dados
     * 
	...
	try {
	    ...
	    /**
	     * Usar este código abaixo para encontrar todos os UIDs com os grupos em uma
	     * chamada ao LDAP só.
	     */
